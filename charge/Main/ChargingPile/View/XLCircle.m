...
-(void)buildLayout
{
    ...
    backLayer.strokeColor  = [UIColor colorWithRed:202.0/255.0f green:208.0/255.0f blue:213.0/255.0f alpha:1].CGColor;
    ...
    //指定path的渲染颜色
    _progressLayer.strokeColor  = [UIColor colorWithRed:48.0/255.0f green:229.0/255.0f blue:120.0/255.0f alpha:1].CGColor;
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[RGB(48, 229, 120) CGColor],(id)[RGB(48, 240, 130) CGColor], nil]];
    ...
    _endPoint.backgroundColor = RGB(48, 229, 120);
