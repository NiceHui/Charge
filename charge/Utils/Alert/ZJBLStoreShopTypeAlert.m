...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont systemFontOfSize:12*XLscaleH];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont boldSystemFontOfSize:13*XLscaleH];
        _titleLabel.textAlignment = NSTextAlignmentCenter;
    }
    return _titleLabel;
}
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        ...
        _closeButton.titleLabel.font = [UIFont systemFontOfSize:13*XLscaleH];
...
- (instancetype)initWithTitle:(NSString *)title titles:(NSArray *)titles selectIndex:(SelectIndex)selectIndex selectValue:(SelectValue)selectValue showCloseButton:(BOOL)showCloseButton {
    if (self = [super init]) {
        ...
        alertHeight = 30*XLscaleH*N+60*XLscaleH;
        if (alertHeight>300*XLscaleH) {
            alertHeight=300*XLscaleH;
        }
        
        buttonHeight = 30*XLscaleH;
